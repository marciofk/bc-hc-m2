const EXTERNAL_API_SERVER = "http://ec2-35-180-227-119.eu-west-3.compute.amazonaws.com:5000"
...
async function deliverEggs(transaction) {
    ...
    console.log('@debug deliverEggs: getting EggBox registry')
    ...
    console.log('@debug deliverEggs: getting Shipment registry')    
    ...
    console.log('@debug deliverEggs: getting Shipment event registry')    
    ...
    event.distId = transaction.shipment.to.memberId
