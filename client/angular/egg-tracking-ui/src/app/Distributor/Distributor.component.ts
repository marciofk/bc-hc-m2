...
export class DistributorComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'nl.hva.blockchain.eggtracking.model.participant.Distributor',
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceDistributor.updateParticipant(form.get('memberId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
